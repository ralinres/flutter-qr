...
class DireccionesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder <List <ScanModel>>(//para manejar el stream necesito el stream builder
      stream:  scanBloc.scansStreamHttp, //este el metodo que retorna el strema ( StreamBuilder necesita un stream para consumir )
                        ...
                        itemBuilder: (context, index) {
                              return Dismissible( //este widget permite deslizar sus elementos izquerda o derecha
                                  ...
                                  child: ListTile(
                                          ...
                                          leading: Icon(Icons.web,color: Theme.of(context).primaryColor),//icono a inicio
